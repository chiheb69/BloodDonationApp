import 'package:BloodDonationAppChiheb/widgets/BloodTestReport.dart';
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  TextWidget(text: '  Research Center', fontSize: 14, color: knormalText),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  TextWidget(text: 'Monastir', fontSize: 14, color: knormalText),
                ],
              ),
